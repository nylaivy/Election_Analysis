...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (countyVotes > largest_countyTurnout_votes):
            largest_countyTurnout_votes = countyVotes
    ...
    county_summary = (
        ...
        #f"Vote count for county with largest turnout: {largest_countyTurnout_votes:,}\n"
        f"-------------------------\n")
